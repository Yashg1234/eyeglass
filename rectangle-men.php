   ...
   <?php require_once("header.php"); ?>
    <main id="content" class="wrapper layout-page">
        ...
        <div class="row gx-30px gy-30px">
            <div class="col-12 col-lg-8 col-md-7" data-animate="fadeInUp">
                <div class="card border-0 rounded-0 banner-06 hover-zoom-in hover-shine">
                    <img class="lazy-image w-100 card-img object-fit-cover light-mode-img" src="#" data-src="assets/images/banner/banner-10.jpg" width="930" height="420" alt="Discover Our Autumn Skincare">
                    <div class="card-img-overlay p-md-12 m-2 p-9">
                        <h5 class="card-subtitle ls-1 mb-4 fw-semibold fs-15px text-body-emphasis fw-bold pb-3">NEW COLLECTION</h5>
                        <h3 class="card-title card-title lh-45px fs-3 font-primary mw-lg-60 pe-xl-25 pe-lg-10 pe-md-0 pe-sm-20">Discover Our Autumn Skincare</h3>
                        <div class="mt-7"><a href="#" class="btn btn-white">Explore More</a></div>
                    </div>
                </div>
            </div>
            <div class="col-12 col-lg-4 col-md-5" data-animate="fadeInUp">
                <div class="card border-0 rounded-0 banner-01 hover-zoom-in hover-shine">
                    <img class="lazy-image object-fit-cover card-img light-mode-img" src="#" data-src="assets/images/banner/banner-09.jpg" width="690" height="420" alt="25% off Everything">
                    <div class="card-img-overlay d-inline-flex flex-column p-md-12 m-md-2 p-8">
                        <h3 class="card-title lh-45px fs-3">25% off Everything</h3>
                        <p class="card-text fs-15px text-body-emphasis mw-xl-60">Makeup with extended range in colors for every human.</p>
                        <div class="mt-7"><a href="#" class="btn btn-white">Shop Sale</a></div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="container">
                    <nav class="py-4 lh-30px" aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center py-1">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Women's Glasses</li>
                        </ol>
                    </nav>
                </div>
            </div>
            <div class="text-center py-13">
                <div class="container">
                    <h2 class="mb-0">Oliver Peoples Glasses</h2>
                    <p class="mb-9">
                    Oliver Peoples is a luxury eyewear brand from the USA, fusing superior Italian workmanship with effortlessly cool Stateside aesthetics. We stock a fantastic range of Oliver Peoples frames, including glasses and sunglasses, and products for both men and women.
                    </p>
                </div>
            </div>
        </section>
        ...
        <div class="container container-xxl pb-16 pb-lg-18">
            <div class="row">
                        ...
                        <div class="col-sm-6  col-lg-4 col-xl-3">
                            <div class="card card-product grid-2 bg-transparent border-0" data-animate="fadeInUp">
                                <figure class="card-img-top position-relative mb-7 overflow-hidden">
                                    <a href="tom-ford-ft5634-b-001.php" class="hover-zoom-in d-block"
                                        title="Shield Conditioner">
                                        <img src="#" data-src="assets/images/products/product-01-330x4402.jpg"
                                ...
                                <div class="card-body text-center p-0">
                                    <span
                                        ...
                                        <del class=" text-body fw-500 me-4 fs-13px">$266.00</del>
                                        <ins class="text-decoration-none">$152.00</ins></span>
                                    <h4
                                        class="product-title card-title text-primary-hover text-body-emphasis fs-15px fw-500 mb-3">
                                        <a class="text-decoration-none text-reset" href="product-details-v1.html">OLIVER PEOPLES</a></h4>
                                        <span class="reviews ms-4 pt-3 fs-14px">COLERIDGE OV1186</span>
                            ...
                            <div class="card card-product grid-2 bg-transparent border-0" data-animate="fadeInUp">
                                ...
                                <span
                                    ...
                                    <h4
                                        class="product-title card-title text-primary-hover text-body-emphasis fs-15px fw-500 mb-3">
                                        <a class="text-decoration-none text-reset" href="product-details-v1.html">OLIVER PEOPLES</a></h4>
                                        <span class="reviews ms-4 pt-3 fs-14px">DESMON OV5454U</span>
                                ...
                                <span
                                    ...
                                    <h4
                                        ...
                                        <a class="text-decoration-none text-reset"
                                            href="tom-ford-ft5634-b-001.php">OLIVER PEOPLES</a></h4>
                                            <span class="reviews ms-4 pt-3 fs-14px">MP-2 OV1104</span>
                        ...
                        <div class="col-sm-6  col-lg-4 col-xl-3">
                            <div class="card card-product grid-2 bg-transparent border-0" data-animate="fadeInUp">
                                ...
                                <div class="card-body text-center p-0">
                                    ...
                                    <h4
                                        class="product-title card-title text-primary-hover text-body-emphasis fs-15px fw-500 mb-3">
                                        <a class="text-decoration-none text-reset" href="tom-ford-ft5634-b-001.php">OLIVER PEOPLES</a></h4>
                                        <span class="reviews ms-4 pt-3 fs-14px">DAWSON OV1144T</span>
                            ...
                            <div class="card card-product grid-2 bg-transparent border-0" data-animate="fadeInUp">
                                ...
                                <div class="card-body text-center p-0">
                                    ...
                                    <h4
                                        class="product-title card-title text-primary-hover text-body-emphasis fs-15px fw-500 mb-3">
                                        <a class="text-decoration-none text-reset"
                                            href="tom-ford-ft5634-b-001.php">Enriched Hand Wash</a></h4>
                                    <div class="d-flex align-items-center fs-12px justify-content-center">
                                        <div class="rating">
                        ...
                        <div class="col-sm-6  col-lg-4 col-xl-3">
                            <div class="card card-product grid-2 bg-transparent border-0" data-animate="fadeInUp">
                                <figure class="card-img-top position-relative mb-7 overflow-hidden">
                                    <a href="tom-ford-ft5634-b-001.php" class="hover-zoom-in d-block"
                                        title="Enriched Duo">
                                        <img src="#" data-src="assets/images/products/product-06-330x441.jpg"
                            ...
                            <div class="card card-product grid-2 bg-transparent border-0" data-animate="fadeInUp">
                                <figure class="card-img-top position-relative mb-7 overflow-hidden">
                                    <a href="tom-ford-ft5634-b-001.php" class="hover-zoom-in d-block"
                                        ...
                                        <img src="#" data-src="assets/images/products/product-11-330x442.jpg"
                ...
                <div class="col-lg-3 d-lg-block d-none py-5" style="border: grey solid 2px;">
                    <div class="position-sticky top-0">
                        <aside class="primary-sidebar pe-xl-9 me-xl-2 mt-12 pt-2 mt-lg-0 pt-lg-0">
                            ...
                            <div class="widget widget-product-category">
                                ...
                                <ul class="navbar-nav1 navbar-nav-cate" id="widget_product_category">
                                    <li class="nav-item">
                                        <a href="#" title="brands"
                                            class="text-reset position-relative d-block text-decoration-none text-body-emphasis-hover d-flex align-items-center text-uppercase fs-14px fw-semibold letter-spacing-5"><span
                                                class="text-hover-underline">brands</span></a>
                                    </li>
                                    <li class="nav-item">
                                        <div title="Skin care"
                                            ...
                                            <span class="text-hover-underline me-2">Oliver Peoples </span>
                                        ...
                                        <div id="cat_skin-care" class="collapse show"
                                            ...
                                            <ul class="navbar-nav nav-submenu ps-8">
                                                <li class="nav-item">
                                                    ...
                                                    href="ted-baker.php"><span class="text-hover-underline">Ted Baker</span></a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="text-reset position-relative d-block text-decoration-none text-body-emphasis-hover d-flex align-items-center"
                                                        href="ray-ban.php"><span class="text-hover-underline"> Ray-Ban</span></a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="text-reset position-relative d-block text-decoration-none text-body-emphasis-hover d-flex align-items-center"
                                                        href="ray-ban-ferrari.php "><span class="text-hover-underline"> Ray-Ban Ferrari </span></a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="text-reset position-relative d-block text-decoration-none text-body-emphasis-hover d-flex align-items-center"
                                                        href="versace.php"><span class="text-hover-underline">Versace</span></a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="text-reset position-relative d-block text-decoration-none text-body-emphasis-hover d-flex align-items-center"
                                                        href="face-oils.php"><span class="text-hover-underline">Face Oils</span></a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="text-reset position-relative d-block text-decoration-none text-body-emphasis-hover d-flex align-items-center"
                                                        href="oakley.php"><span
                                                            class="text-hover-underline">Oakley</span></a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="text-reset position-relative d-block text-decoration-none text-body-emphasis-hover d-flex align-items-center"
                                                        href="prada.php"><span class="text-hover-underline">Prada</span></a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="text-reset position-relative d-block text-decoration-none text-body-emphasis-hover d-flex align-items-center"
                                                        href="prada-linea-rossa.php"><span class="text-hover-underline"> Prada Linea Rossa</span></a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="text-reset position-relative d-block text-decoration-none text-body-emphasis-hover d-flex align-items-center"
                                                        href="polo-ralph-lauren.php"><span class="text-hover-underline"> Polo Ralph Lauren</span></a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="text-reset position-relative d-block text-decoration-none text-body-emphasis-hover d-flex align-items-center"
                                                        href="persol.php"><span class="text-hover-underline">Persol</span></a>
                                                </li>
                                            </ul>
                                        </div>
                                    </li>
                            ...
                            <div class="widget widget-product-category">
                                <h4 class="widget-title fs-5 mb-6">Shapes</h4>
                                <ul class="navbar-nav1 navbar-nav-cate" id="widget_product_category">
                                    <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <div title="Skin care"
                                            class="text-reset position-relative d-block text-decoration-none text-body-emphasis-hover d-flex align-items-center text-uppercase fs-14px fw-semibold letter-spacing-5 ">
                                            <span class="text-hover-underline me-2">Shapes </span>
                                            <span data-bs-toggle="collapse" data-bs-target="#cat2"
                                                class="caret flex-grow-1 d-flex align-items-center justify-content-end collapsed"><svg
                                                    class="icon">
                                                    <use xlink:href="#icon-plus"></use>
                                                </svg></span> </div>
                                        <div id="cat2" class="collapse show"
                                            data-bs-parent="#widget_product_category">
                                            <ul class="navbar-nav nav-submenu ps-8">
                                                <li class="nav-item">
                                                    <a class="text-reset position-relative d-block text-decoration-none text-body-emphasis-hover d-flex align-items-center"                                  
                                                    href="ted-baker.php"><span class="text-hover-underline">Rectangular </span></a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="text-reset position-relative d-block text-decoration-none text-body-emphasis-hover d-flex align-items-center"
                                                        href="ray-ban.php"><span class="text-hover-underline"> Square</span></a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="text-reset position-relative d-block text-decoration-none text-body-emphasis-hover d-flex align-items-center"
                                                        href="ray-ban-ferrari.php "><span class="text-hover-underline"> Round </span></a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="text-reset position-relative d-block text-decoration-none text-body-emphasis-hover d-flex align-items-center"
                                                        href="versace.php"><span class="text-hover-underline">Oval </span></a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="text-reset position-relative d-block text-decoration-none text-body-emphasis-hover d-flex align-items-center"
                                                        href="face-oils.php"><span class="text-hover-underline">Pillow</span></a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="text-reset position-relative d-block text-decoration-none text-body-emphasis-hover d-flex align-items-center"
                                                        href="face-oils.php"><span class="text-hover-underline"> Aviator / Pilot</span></a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="text-reset position-relative d-block text-decoration-none text-body-emphasis-hover d-flex align-items-center"
                                                        href="oakley.php"><span
                                                            class="text-hover-underline">Geometric</span></a>
                                                </li>
                            ...
                            <div class="widget widget-product-category">
                                <h4 class="widget-title fs-5 mb-6">Material</h4>
                                <ul class="navbar-nav1 navbar-nav-cate" id="widget_product_category">
                                    <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <div title="Skin care"
                                            ...
                                            <span data-bs-toggle="collapse" data-bs-target="#cat3"
                                                class="caret flex-grow-1 d-flex align-items-center justify-content-end collapsed">
                                                 </div>
                                        <div id="cat3" class="collapse show"
                                            data-bs-parent="#widget_product_category">
                                            <ul class="navbar-nav nav-submenu ps-8">
                                                <li class="nav-item">
                                                    <a class="text-reset position-relative d-block text-decoration-none text-body-emphasis-hover d-flex align-items-center"                                  
                                                    href="ted-baker.php"><span class="text-hover-underline">Plastic </span></a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="text-reset position-relative d-block text-decoration-none text-body-emphasis-hover d-flex align-items-center"
                                                        href="ray-ban.php"><span class="text-hover-underline"> Metal</span></a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="text-reset position-relative d-block text-decoration-none text-body-emphasis-hover d-flex align-items-center"
                                                        href="ray-ban-ferrari.php "><span class="text-hover-underline"> Titanium </span></a>
                                                </li>
                            ...
                            <div class="widget widget-product_colors">
                                ...
                                <ul class="navbar-nav1 navbar-nav-cate" id="widget_product_colors">
                                    <li class="nav-item">
                                        <a href="#" title="Black"
...
<!-- Mirrored from templates.g5plus.net/glowing-bootstrap-5/shop/shop-layout-v2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 10:41:01 GMT -->
